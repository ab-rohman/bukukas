package com.example.bukukasnusantara.adapter
...
import com.example.bukukasnusantara.R
import com.example.bukukasnusantara.model.TransactionModel
...
class TransactionAdapter (private val transactionList: List<TransactionModel>) : RecyclerView.Adapter<TransactionAdapter.ListViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        ...
        if (transaction.category == "Pemasukan") {
            ...
            holder.ivCategory.setImageResource(R.drawable.income)
        } else {
            holder.tvCategory.text = "[ - ]"
            holder.ivCategory.setImageResource(R.drawable.expense)
        }
